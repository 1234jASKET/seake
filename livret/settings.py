"""
Django settings for livret project.
...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-_^!yazp8jq$5hb$kbg)v!w)9#i+o#h^_q57t+xxuv958zy(&m*',
)
...
WSGI_APPLICATION = 'livret.wsgi.application'
